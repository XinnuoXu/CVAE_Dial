...
class pre_processor(object):
	...
	def preprocessing(self, line):
		...
		# STEMMING “stemming” “stemmer” “stemmed” -> “stem”
		return [self.p_stemmer.stem(i) for i in stopped_tokens \
			if not self.filtered(self.p_stemmer.stem(i))]

if __name__ == '__main__':
	# Testing
	pp = pre_processor()
	for line in open("examples/GloVe_train.dat"):
		print pp.preprocessing(line.strip().decode("utf8", "ignore"))
